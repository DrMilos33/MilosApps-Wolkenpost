...
`public-app-essentials/v1.1.5` und Shared-Commit
`2942132ad3bf6cf39edc9f52ed918de6a230be23` gepinnt.
...
|---|---|---|---|
| `localStorage`: `milosapps.cloud-post.state` | Eigene Zeichnung, gewähltes Flugprofil, grober letzter Startpunkt, bewusst gewählte Darstellungs-, Bewegungs- und Toneinstellungen sowie der lokale Reisepass (Anzahl der Flüge und freigespielte Länder-/Wahrzeichenkennungen). Ermöglicht die ausdrücklich angebotene lokale Wiederaufnahme, das Reisejournal und Offline-Nutzung. | Bis „Lokale Daten löschen“ oder Browserlöschung. | Technisch notwendig für die angebotene lokale Wiederaufnahme und das vom Nutzer ausgelöste Sammelspiel; verlässt das Gerät nicht. |
